...
export default function SectionAbout() {
    return (
        <section id="about" className="py-16 backdrop-blur-3xl  md:py-2 bg-gradient-to-r from-it4a-primary/500 via-it4a-secondary to-it4a-orange/50 ">
            <div className="container mx-auto px-4">
                <div className="flex  flex-col lg:flex-row items-center gap-2 ">
                    <div className="sm:flex sm:flex-col items-center md:items-start lg:w-1/2 mb-12 lg:mb-0 lg:pr-12 space-y-4">
                        <TitleDescript className="text-center md:text-left " title="À Savoir sur ITEA" descript="IT Experts 4 Africa est une entreprise spécialisée dans le conseil et l'implémentation des solutions IT, couvrant les infrastructures informatiques, le cloud, la cybersécurité et les réseaux. Notre marque repose sur l'expertise, l'innovation et une approche axée sur le client pour optimiser les technologies des entreprises et favoriser leur croissance en Afrique." />

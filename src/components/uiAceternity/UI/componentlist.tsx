...
export const ServicesComplementaire: React.FC<ServicesProps> = (
  ...
  return (
    ...
    <section className={` py-2 md:p-4 h-full w-full flex flex-col items-center backdrop-blur-xs px-2  p-4  bg-it4a-secondary/50 justify-center scroll-mt-px z-0 ${className} `}>
